...
<title>爱码购后台管理</title>
<link rel="icon" href="${pageContext.request.contextPath}/images/admin_icon.png" type="image/x-icon" />
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post">
			<table cellspacing="4px;">
				<tr>
					<td>用户名：</td>
					<td><input type="text" name="adminName" id="userName"
						readonly="readonly" value="${adminName }" style="width: 200px;" /></td>
				</tr>
				<tr>
					<td>原密码：</td>
				...
				<tr>
					<td>新密码：</td>
					<td><input type="password" class="easyui-validatebox"
						id="newPassword" style="width: 200px;" required="true" /></td>
				</tr>
				<tr>
					<td>确认新密码：</td>
					<td><input type="password" class="easyui-validatebox"
						name="newPassword" id="newPassword2" style="width: 200px;"
						required="true" /></td>
				</tr>
			</table>
		</form>
