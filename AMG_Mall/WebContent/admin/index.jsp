				...
				<form action="adminLogin.user" method="post">
					<div class="log">
						...
						<div class="pwd">
							...
							<label>验证码</label><input type="text" class="text" id="value_1"
								placeholder="验证码" name="SecurityCode" tabindex="3"
								style="margin-top: 10px; width: 100px;"><img
								id="CreateCheckCode" src="genImage.code" onclick="changeImage()">
